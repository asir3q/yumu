...
function yumu_the_post_thumbnail($postID) {
    ...
    if($already_has_thumb){
        ...
        if ($attached_image){
            ...
            $thumbarr=Array(
                get_template_directory_uri().'/style/img/f0766dd2d7bfc5dea3562cb728ea47f4.jpg',
                get_template_directory_uri().'/style/img/f62e2961be366795facaf7d070a683d4.jpg',
                get_template_directory_uri().'/style/img/6d493ed44efebc946be986d110da846f.jpg');
