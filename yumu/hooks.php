...
add_action('wp_enqueue_scripts', function () {
  if (!is_admin()) {
	wp_enqueue_script('yumus', get_template_directory_uri().'/style/js/yumus.min.js','',false,true);	
	wp_enqueue_style('style', get_template_directory_uri().'/style/css/style.min.css');
